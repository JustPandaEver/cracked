...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/JustPandaEver/cracked/main/"
start=$(date +%s)
secs_to_human() {
...
wget raw.githubusercontent.com/JustPandaEver/cracked/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
cd
